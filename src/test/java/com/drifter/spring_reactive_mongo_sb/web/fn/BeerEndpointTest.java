...
import com.drifter.spring_reactive_mongo_sb.services.BeerServiceImplTest;
...
class BeerEndpointTest {
    ...
    void testPatchIdNotFound() {
        webTestClient.patch()
                .uri(BeerRouterConfig.BEER_PATH_WITH_ID, 999)
    ...
    void testPatchIdFound() {
        ...
        webTestClient.patch()
                .uri(BeerRouterConfig.BEER_PATH_WITH_ID, beerDTO.getId())
    ...
    void testUpdateBeerBadRequest() {
        ...
        webTestClient.put()
                .uri(BeerRouterConfig.BEER_PATH_WITH_ID, testBeer)
    ...
    void testGetByIdNotFound() {
        webTestClient.get().uri(BeerRouterConfig.BEER_PATH_WITH_ID, 999)
                .exchange()
                .expectStatus().isNotFound();
    }
    ...
    void testGetById() {
        ...
        webTestClient.get().uri(BeerRouterConfig.BEER_PATH_WITH_ID, beerDTO.getId())
                .exchange()
                .expectStatus().isOk()
